...
class Webhook(WebhookBase):
    ...
    def _update_no_return(self, data):
        ...
        data : `dict` of (`str`, `Any`) items
            Received webhook data.
        """
        self.channel = channel = create_partial_channel_from_id(
        ...
        if kwargs:
            ...
            for attribute_name, lower_limit, upper_limit in (
                ...
                try:
                    ...
                    attribute_value = preconvert_str(
                        attribute_value, attribute_name, lower_limit, upper_limit
                    )
            ...
            for attribute_name, attribute_type in (
                ...
                try:
                    ...
                    attribute_value = instance_or_id_to_instance(
                        attribute_value, attribute_type, attribute_name
                    )
                    processable.append((attribute_name, attribute_value))
    ...
    async def _from_follow_data(cls, data, source_channel, target_channel, client):
        ...
        if guild is None:
            try:
                ...
                avatar_type, avatar_hash = Icon.from_base16_hash(
