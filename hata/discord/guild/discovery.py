...
class GuildDiscovery:
    ...
    def _update_no_return(self, data):
        ...
        self.sub_categories = set(
            DiscoveryCategory.from_id(category_id)
        ...
        self.primary_category = DiscoveryCategory.from_id(
            data['primary_category_id'], primary=True
        )
...
DiscoveryCategory.relationships_and_identity = DiscoveryCategory(
...
DiscoveryCategory.crafts_diy_and_making = DiscoveryCategory(
...
DiscoveryCategory.news_and_current_events = DiscoveryCategory(
...
DiscoveryCategory.studying_and_teaching = DiscoveryCategory(
    29, 'Studying & Teaching', False
)
...
DiscoveryCategory.comics_and_cartoons = DiscoveryCategory(
...
DiscoveryCategory.charity_and_nonprofit = DiscoveryCategory(
