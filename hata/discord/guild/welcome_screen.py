...
class WelcomeScreen:
    ...
    def from_data(cls, data):
        ...
        if (welcome_channel_datas is None) or (not welcome_channel_datas):
            ...
            welcome_channels = tuple(
                WelcomeChannel.from_data(welcome_channel_data)
                for welcome_channel_data in welcome_channel_datas
            )
    ...
    def to_data(self):
        ...
        return {
            ...
            'welcome_channels': [
                welcome_channel.to_data() for welcome_channel in self.welcome_channels
            ],
        }
    ...
    def __repr__(self):
        ...
        return (
            f'<{self.__class__.__name__} description={reprlib.repr(self.description)}, welcome_channels='
...
class WelcomeChannel:
    ...
    def custom(cls, base, **kwargs):
        ...
        **kwargs : keyword parameters
        ...
        while True:
            try:
                ...
                if isinstance(channel, ChannelText):
                    ...
                    raise TypeError(
                        f'`channel` parameters can be given as {ChannelText.__name__} or `int` instance,'
            ...
            if base is None:
                raise TypeError(
                    f'`channel` or `channel_id` are required parameters if `{cls.__name__}.custom` is '
        ...
        try:
            ...
            if base is None:
                raise TypeError(
                    f'`description` is a required parameter if `{cls.__name__}.custom` is called as a '
                    f'classmethod.'
                ) from None
            ...
            if not isinstance(description, str):
                raise TypeError(
                    f'`description` can be given as `str` instance, got {description.__class__.__name__}.'
                )
        ...
        try:
            ...
            if base is None:
                raise TypeError(
                    f'`emoji` is a required parameter if `{cls.__name__}.custom` is called as a '
                    f'classmethod.'
                ) from None
            ...
            if not isinstance(emoji, Emoji):
                raise TypeError(
                    f'`emoji` can be given as `{Emoji.__name__}` instance, got {emoji.__class__.__name__}.'
                )
    ...
    def __repr__(self):
        ...
        return (
            f'<{self.__class__.__name__} channel_id={self.channel_id},  emoji={self.emoji!r}, description='
