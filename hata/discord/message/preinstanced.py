...
def convert_welcome(self):
    ...
    return join_messages[int(self.created_at.timestamp()) % len(join_messages)].format(
        self.author.name
    )
...
def convert_new_follower_channel(self):
    ...
    return (
        f'{user_name} has added {guild_name} #{channel.name} to this channel. Its most important updates '
        'will show up here.'
    )
...
def convert_discovery_grace_period_initial_warning(self):
    return (
        'This server has failed Discovery activity requirements for 1 week. If this server fails for 4 weeks in '
...
def convert_discovery_grace_period_final_warning(self):
    return (
        'This server has failed Discovery activity requirements for 3 weeks in a row. If this server fails for 1 '
...
class MessageType(PreinstancedBase):
    ...
    discovery_disqualified = P(
        14, 'discovery_disqualified', convert_discovery_disqualified
    )
    discovery_requalified = P(
        15, 'discovery_requalified', convert_discovery_requalified
    )
    discovery_grace_period_initial_warning = P(
        16,
        'discovery_grace_period_initial_warning',
        convert_discovery_grace_period_initial_warning,
    )
    discovery_grace_period_final_warning = P(
        17,
        'discovery_grace_period_final_warning',
