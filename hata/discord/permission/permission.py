...
class Permission(
    FlagBase, access_keyword='can', enable_keyword='allow', disable_keyword='deny'
):
    """
...
PERMISSION_TEXT_AND_VOICE_DENY = Permission(
    PERMISSION_TEXT_DENY | PERMISSION_VOICE_DENY
)
