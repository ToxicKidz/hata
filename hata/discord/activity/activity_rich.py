...
class ActivityRich(ActivityBase):
    ...
    def __new__(cls, name, url=None, type_=ACTIVITY_TYPES.game):
        ...
        if type_ == ACTIVITY_TYPES.custom:
            raise RuntimeError(
                f'Custom activity cannot be created with `{cls.__name__}.__new__`.'
            )
    ...
    def start(self):
        ...
        return datetime.utcfromtimestamp(start / 1000.0)
    ...
    def end(self):
        ...
        return datetime.utcfromtimestamp(end / 1000.0)
    ...
    def duration(self):
        ...
        return datetime.utcfromtimestamp(end / 1000.0) - datetime.utcfromtimestamp(
            start / 1000.0
        )
