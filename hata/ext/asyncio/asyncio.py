...
class EventThread:
    ...
    def getaddrinfo(self, host, port, *, family=0, type=0, proto=0, flags=0):
        return self.get_address_info(
            host, port, family=family, type=type, protocol=proto, flags=flags
        )
...
async def asyncio_subprocess_shell(
    ...
    **kwargs,
    ...
    return await hata_EventThread_subprocess_shell(
        self,
        *args,
...
async def asyncio_subprocess_exec(
    ...
    **kwargs,
    ...
    return await hata_EventThread_subprocess_exec(
        self,
        *args,
        preexecution_function=preexecution_function,
        creation_flags=creation_flags,
...
async def asyncio_create_connection(
    self,
    *args,
    protocol=0,
    proto=0,
    ...
    **kwargs,
    ...
    return await hata_EventThread_create_connection(
        self,
        *args,
        protocol=protocol,
        socket=socket,
...
async def asyncio_create_datagram_endpoint(
    self,
    protocol_factory,
    local_addr=None,
    remote_addr=None,
    ...
    **kwargs,
    ...
    return await hata_EventThread_create_datagram_endpoint(
        self,
        protocol_factory,
        local_address=local_address,
...
async def asyncio_create_server(
    self, *args, sock=None, socket=None, reuseport=None, reuse_port=None, **kwargs
):
    ...
    return await hata_EventThread_create_server(
        self, *args, reuse_port=reuse_port, socket=socket, **kwargs
    )
...
class IncompleteReadError(EOFError):
    ...
    def __init__(self, partial, expected):
        EOFError.__init__(
            self, f'{len(partial)} bytes read on a total of {expected!r} expected bytes'
        )
...
BaseProactorEventLoop = (
    EventThread  # Note, that hata has no proactor event_loop implemneted.
)
...
class StreamWriter:
    ...
    def __repr__(self):
        result = ['<', self.__class__.__name__, 'transport=', repr(self._transport)]
...
class StreamReader:
    ...
    def feed_data(self, data):
        ...
        if (
            ...
            and (len(self._buffer) > (self._limit << 1))
        ):
            try:
...
if IS_UNIX:
    ...
    async def create_subprocess_shell(
        ...
        **kwargs,
        ...
        return await loop.subprocess_shell(
    ...
    async def create_subprocess_exec(
        ...
        **kwargs,
        ...
        return await loop.subprocess_exec(
            program, *args, stdin=stdin, stdout=stdout, stderr=stderr, **kwargs
        )
...
class Task(HataTask, metaclass=TaskMeta, ignore=True):
    __slots__ = ('__weakref__',)  # Required by anyio
    ...
    def current_task(loop=None):
        if loop is None:
            ...
            if not isinstance(loop, EventThread):
                raise TypeError(
                    f'`loop` was not given es `{EventThread.__name__}` instance, got '
