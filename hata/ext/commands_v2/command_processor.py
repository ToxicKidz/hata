...
class CommandProcessor(EventWaitforBase):
    ...
    def __new__(
        ...
        *,
        ...
        if default_category_name is None:
            ...
            default_category_name = validate_category_or_command_name(
        ...
        mention_prefix_enabled = preconvert_bool(
            mention_prefix_enabled, 'mention_prefix_enabled'
        )
    ...
    def get_category(self, category_name):
        ...
        if not isinstance(category_name, str):
            raise TypeError(
                f'`category_name` can be given as `None` or as `str` instance, got '
    ...
    def delete_category(self, category):
        ...
        if isinstance(category, Category):
            ...
            raise TypeError(
                f'`category` can be given either as `{Category.__name__}` or as `str` instance, '
        ...
        if __debug__:
            if not isinstance(command, Command):
                raise AssertionError(
                    f'`command` can be given as `{Command.__name__}` instance, got '
